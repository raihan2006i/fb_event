...
describe AuthenticationsController do
  ...
  describe "Post 'create'" do
    describe "twitter" do
      ...
      it "should create authentication for exisisting twitter user" do
        lambda do
      ...
      it "should create authentication for twitter " do
        lambda do
          post :create, :provider => "twitter"
          controller.stub!(:sign_in_and_redirect).and_return(true)
          response.should redirect_to(profile_user_path(Authentication.last.user))
        end.should change(Authentication, :count).by(1)
      end

      it "user should create authentication and save user" do
        lambda do
          post :create, :provider => "twitter"
          controller.stub!(:sign_in_and_redirect).and_return(true)
          response.should redirect_to(profile_user_path(Authentication.last.user))
    ...
    describe "facebook" do
      ...
      it "should create authentication for exisisting facebook user" do
        lambda do
          @user = Factory(:confirmed_user)
          sign_in @user
      ...
      it "should create authentication for facebook " do
        lambda do
          post :create, :provider => "facebook"
          controller.stub!(:sign_in_and_redirect).and_return(true)
          response.should redirect_to(profile_user_path(Authentication.last.user))
    ...
    describe "google_oauth2" do
      ...
      it "should create authentication for exisisting google user" do
        lambda do
          @user = Factory(:confirmed_user)
          sign_in @user
      ...
      it "should create authentication for google " do
        lambda do
          post :create, :provider => "google_oauth2"
          controller.stub!(:sign_in_and_redirect).and_return(true)
          response.should redirect_to(profile_user_path(Authentication.last.user))
